...
def part1(values_list) -> str:
    ...
    # Point(x=11, y=1)
    # Point(x=2, y=5)
    fin_area = box(86377, 82538, 16499, 14580).area
    print(fin_area)
    print(fin_area)
    print(fin_area)

    # Point(x=16500, y=14581)
    # Point(x=16499, y=14580)

    # print_grid(grid, max_x=max_x, max_y=max_y)
    result = 50
    print(result)
    return f"{result}"
