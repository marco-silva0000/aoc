...
def part1(values_list) -> str:
    ...
    for code in codes:
        ...
        def calculate_next_combinations(combinations):
            new_combinations = []
            for combination in combinations:
                log.debug(f"combination start", combination=combination)
            ...
            new_new_combinations = []
            for combination in new_combinations:
                new_combinations.extend(product(*combination))
            return new_new_combinations

        for index in range(n_robots):
            combinations = calculate_next_combinations(combinations)
            for combination in combinations:
